const dashboardApp = new Vue({
    ...
    methods: {
        ...
        setAliasName() {
            this.aliasName = this.virtualAliases[
                this.selectedVAliasesIndex
            ].destination;
        },
        removeAlias() {
            this.waitForResponse = false;
            $.post(
                "/virtual-aliases/remove",
                {
        ...
        setDomainName() {
            this.domainName = this.virtualDomains[
                this.selectedVDomainsIndex
            ].name;
        },
        clearDomain() {
